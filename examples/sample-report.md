...
**high confidence** · `src/client/releases.ts:16-28` · `fetchRelease` · hotspot H01 (score 1.86)
...
**high confidence** · `src/sync/collection.ts:4-16` · `syncCollection` · hotspot H02 (score 0.7111)
...
**high confidence** · `src/util/format.ts:4-16` · `formatTitle` · hotspot H09 (score 0.012)
...
**medium confidence** · `src/sync/scheduler.ts:1-13` · `submit` · hotspot H03 (score 0.3421)
